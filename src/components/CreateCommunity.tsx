...
import BlockBallotAbi from "@/abis/BlockBallot.json";
...
export const CreateCommunity = () => {
  ...
  const createNewProposal = async () => {
    ...
    try {
      ...
      const blockBallotCalldata: CallData = new CallData(BlockBallotAbi);
      const constructorData = blockBallotCalldata.compile("constructor", {
        eligibility_token: eligibilityToken,
        admin: address,
        title: shortString.encodeShortString(title),
      });

      // console.log({ blockBallotCalldata });
      ...
      const deployResponse = await a.deploy({
        classHash: CONTRACT_DETAILS.goerli.BlockBallot.classhash,
